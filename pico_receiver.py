...
def correcta():
    ...
    # Modificación 2: El conteo ocurre estrictamente aquí (señal de acierto)
    aciertos += 1
...
>>>>>>> ee2bf70f6e38131d98f27d694e30afa4f508a80b
    for _ in range(2):
        ...
        for l in green_leds:
            l.value(0)
        sleep_ms(120) # Pequeña pausa añadida para asegurar un buen parpadeo
...
def procesar(cmd):
    ...
    # Modificación 3: Agregamos la "U" a la lista de comandos para resetear
    elif cmd in ["RESET", "U"]:
        reset()
